...
class Instagram_bot():
    ...
    def like_photo_by_hashtag(self, hashtag):
        ...
        for url in post_urls[0:200]:
            try:
                ...
                if random.randrange(1,6) == 3 :self.comment_post(url)
    ...
    def comment_post(self,url):
        ...
        browser.find_element(By.CSS_SELECTOR,'#react-root > section > main > div > div.ltEKP > article > div > div.qF0y9.Igw0E.IwRSH.eGOV_._4EzTm > div > div > section.sH9wk._JgwE > div > form > button.sqdOP.yWX7d.y3zKF').click()
